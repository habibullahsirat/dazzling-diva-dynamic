...
//         {/* Product Image */}
//         <div className="relative h-[450px] overflow-hidden rounded bg-[#F7F7F7]">
//           <Image
//             src={product.image}
//             alt={product.title}
//             fill
...
//           <p className="text-3xl font-bold text-[#5A0C3D]">
...
//             {product.isMostLoved && (
//               <span className="rounded bg-pink-100 px-3 py-1 text-sm font-medium text-pink-700">
//                 Most Loved
//               </span>
//             )}
//           </div>

//           <button className="flex items-center gap-2 rounded-lg bg-[#5A0C3D] px-6 py-3 text-white hover:bg-[#43092e]">
//             <ShoppingBag size={20} />
//             Add to Cart
//           </button>
//         </div>
