...
//           `${process.env.NEXT_PUBLIC_ADMIN_API}/api/navbar-categories`,
//           {
//             cache: "no-store",
//           },
//         );
...
//           aria-label="Open categories menu"
//           onClick={() => setCategoryMenuOpen(true)}
//           className="flex shrink-0 flex-col items-start justify-center gap-[6px]"
//         >
//           <span className="block h-[2px] w-[36px] bg-black md:w-[59px]" />
//           <span className="block h-[2px] w-[28px] bg-black md:w-[48px]" />
//           <span className="block h-[2px] w-[20px] bg-black md:w-[36px]" />
...
//                     href={category.href}
//                     onClick={() => setCategoryMenuOpen(false)}
//                     className="flex items-center justify-between py-4 text-[17px] font-medium capitalize transition hover:text-[#5A0C3D]"
//                   >
//                     {category.name}
...
//   return (
//     <>
//       <div className="grid grid-cols-3 items-center px-4 py-4 sm:px-8 md:px-16 md:py-6">
//         {/* Left */}
